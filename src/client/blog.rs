...
#[derive(Default)]
pub struct GetBlogFollowingOptionalParams<'a> {
    limit: Option<&'a str>,
    offset: Option<&'a str>,
}

impl<'a> GetBlogFollowingOptionalParams<'a> {
    pub fn new() -> GetBlogFollowingOptionalParams<'a> { GetBlogFollowingOptionalParams::default() }
